...
[https://github.com/CristianoFIlho/TCP-Client-Server.git](https://github.com/CristianoFIlho/TCP-Client-Server.git)

## 🧙‍♂️ Contribution

1. Make the _fork_ of the project (<https://github.com/CristianoFIlho/TCP-Client-Server.git/fork>)
